...
namespace CarChecker.Server
{
    ...
    public class MyOwnValidator : StrictRedirectUriValidator
    {
        private readonly ILogger _logger;

        /// <summary>
        /// Initializes a new instance of the <see cref="MyOwnValidator"/> class.
        /// </summary>
        /// <param name="logger">The logger.</param>
        public MyOwnValidator(ILogger<MyOwnValidator> logger)
        {
            _logger = logger;
        }
        ...
        /// <c>true</c> is the URI is valid; <c>false</c> otherwise.
        /// </returns>
        public override async Task<bool> IsPostLogoutRedirectUriValidAsync(string requestedUri, IdentityServer4.Models.Client client)
        {
